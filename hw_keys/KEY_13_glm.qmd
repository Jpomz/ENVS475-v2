...
```         
## 1.1 code chunk or answer  

## 1.2  code chunk or answer  

## 1.3 code chunk or answer  etc.
```
...
## 1.4 Graded - two regression lines
...
## 1.7 Graded - 3.65, 38.7; -0.05, -0.94
...
-   `Removed` is the number that were missing 24 hours later (i.e., this is the number that "died"). This is what we are classifying as **successes**
...
## 2.1 Graded - two regression lines
...
## 2.7 Graded - intercepts not different
