...
1.1 Split the data based on species, and make two new data frames, one called `fortis` and one called `scandens`.
...
2.4 Based on the information from 2.3 above, enter a simple aritmetic equation which estimates the the mean beak length for the *scandens* species in *1975*?
